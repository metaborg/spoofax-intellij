 ...
 */
@Singleton
public final class SpoofaxOldBuilder extends TargetBuilder<SpoofaxSourceRootDescriptor, SpoofaxPostTarget> {

    //public static final SpoofaxOldBuilder INSTANCE = new SpoofaxOldBuilder();
...
//    private final LanguageManager languageManager;
    ...
    @Inject
    private SpoofaxOldBuilder(SpoofaxPostTargetType postTargetType) {
        super(Arrays.asList(postTargetType));
