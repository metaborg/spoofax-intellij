 ...
 *
 * Don't use this class directly. Instead use the {@link IdeaMetaborgModuleFacetConfig} class (in IntelliJ IDEA)
 * or the {@link JpsMetaborgModuleFacetConfig} class (in JPS).
 */
