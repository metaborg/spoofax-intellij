 ...
 */
public final class InstanceKeyedExtensionPoint<T> extends KeyedLazyInstanceEP<T> implements IExtensionPointValue {
     ...
     */
    public InstanceKeyedExtensionPoint(final String id, final Language language, final T instance) {
        super();
        this.id = id;
